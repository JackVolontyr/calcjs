...
/***/ function(module, exports, __webpack_require__) {
	...
	var Desk = function (_Methods) {
	  ...
	  function Desk(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Desk.__proto__ || Object.getPrototypeOf(Desk)).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ajaxService = __webpack_require__(5);
	...
	var Calc = function (_Logic) {
	  _inherits(Calc, _Logic);
	  ...
	  _createClass(Calc, [{
	    key: '_renderCalcButtons',
	    value: function _renderCalcButtons(template) {
	      var elem = document.getElementById('calcBtnTemplate').innerHTML;
	      this._input.getElement().innerHTML = _lodash2.default.template(elem)({
	        option: template
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logic = function (_Methods) {
	  _inherits(Logic, _Methods);
	
	  function Logic(options) {
	    _classCallCheck(this, Logic);
	
	    var _this = _possibleConstructorReturn(this, (Logic.__proto__ || Object.getPrototypeOf(Logic)).call(this));
